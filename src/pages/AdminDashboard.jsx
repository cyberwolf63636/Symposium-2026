      ...
      <main className="flex-1 p-8 overflow-y-auto">
        <header className="flex justify-between items-center mb-8">
          ...
          <div className="flex gap-3">
             <button onClick={handleResetDatabase} className="bg-red-600/20 hover:bg-red-600/40 text-red-500 border border-red-900 px-4 py-2 rounded-lg text-sm flex items-center gap-2 transition-all font-bold">
            ...
            <table className="w-full text-left text-sm text-slate-400">
              ...
              <tbody className="divide-y divide-slate-800">
                {loading ? (
                  ...
                  <tr><td colSpan="8" className="text-center py-8">No registrations found</td></tr>
                ) : (
